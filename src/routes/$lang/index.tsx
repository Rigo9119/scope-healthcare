...
export const Route = createFileRoute("/$lang/")({
  loader: async ({ params }) => {
    try {
      // Cap the wait so a slow/unreachable Sanity fetch never blocks render
      // (otherwise the prerender hangs on the skeleton, and users see it too).
      return await Promise.race([
        fetchHomePage(params.lang),
